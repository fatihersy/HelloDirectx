...
void app::MoveToNextFrame() 
{
	...
	// Frame Buffering validation
	OutputDebugStringA((
		"FI:" + std::to_string(m_frameIndex) +
		" cur:" + std::to_string(currentFenceValue) +
		" bufFence:" + std::to_string(m_fenceValues[m_frameIndex]) +
		" done:" + std::to_string(m_fence->GetCompletedValue()) +
		(didWait ? " WAIT" : " OK") + "\n").c_str()
	);
