...
std::wstring platform::m_windowtext = L"";
...
void platform::SetCustomWindowText(LPCWSTR text)
{
	SetWindowText(m_hwnd, std::wstring(platform::m_windowtext + L": " + text).c_str());
}
