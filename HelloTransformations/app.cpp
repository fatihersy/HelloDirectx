...
void app::PopulateCommandList() 
{
	...
	XMMATRIX scaleMatrix = XMMatrixScaling(.2f, .2f, .2f);
	XMMATRIX rotationMatrix = XMMatrixRotationY(-2.f * m_curRotationAngleRad);
	XMMATRIX translateMatrix = XMMatrixTranslation(0.f, 0.f, -5.f);
